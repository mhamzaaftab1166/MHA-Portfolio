...
const dataMap = {
  en: { hero: heroEn, about: aboutEn, skills: skillsEn, experience: experienceEn, projects: projectsEn, contact: contactEn, navbar: navbarEn },
  ar: { hero: heroAr, about: aboutAr, skills: skillsAr, experience: experienceAr, projects: projectsAr, contact: contactAr, navbar: navbarAr },
}
